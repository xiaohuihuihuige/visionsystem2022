#ifndef PRO_ALLOBJDETECT_H
#define PRO_ALLOBJDETECT_H
...
class Pro_AllObjDetect : public QObject
{
    Q_OBJECT
public:
    explicit Pro_AllObjDetect(QObject *parent = nullptr);
    ~Pro_AllObjDetect();

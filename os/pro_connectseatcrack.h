#ifndef PRO_CONNECTSEATCRACK_H
#define PRO_CONNECTSEATCRACK_H
...
class Pro_ConnectSeatCrack : public QObject
{
    Q_OBJECT
public:
    explicit Pro_ConnectSeatCrack(QObject *parent = nullptr);

#ifndef PRO_GLUEWITHSEAT_H
#define PRO_GLUEWITHSEAT_H

#include <QObject>
#include<publicstruct.h>
#include<QMap>
#include<halcon/qthalcon.h>
class Pro_GlueWithSeat : public QObject
{
    Q_OBJECT
public:
    explicit Pro_GlueWithSeat(QObject *parent = nullptr);
    ~Pro_GlueWithSeat();
    ...
    void glue_check (HObject ho_Image, HObject ho_Rectangle, HObject *ho_pipe_seat_region,
